...
namespace MinSG {
	...
	public:
		MINSGAPI RigidJoint(JointNode *source);
		
		MINSGAPI RigidJoint(uint32_t _id, std::string _name);
		MINSGAPI RigidJoint(uint32_t _id, std::string _name, Geometry::Matrix4x4 _offsetMatrix, bool _stacking=false);
