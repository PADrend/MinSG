...
TriangleTree * kDTreeBuilder::buildTriangleTree(Rendering::Mesh * mesh) {
#ifdef MINSG_PROFILING
	std::cout << "Profiling: Creating kDTree(triangles=" << trianglesPerNode
	...
	auto k = new kDTree(mesh, trianglesPerNode, allowedBBEnlargement);
